//package github.lyl21.wanandroid.http.net
//
...
//import github.lyl21.wanandroid.base.http.BaseResult
//
...
// */
//abstract class IStateObserver<T>(view: View?) : Observer<BaseResult<T>>, Callback.OnReloadListener {
