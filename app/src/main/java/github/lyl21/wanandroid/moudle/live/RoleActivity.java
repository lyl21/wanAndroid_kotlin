...
import github.lyl21.wanandroid.moudle.live.utils.WindowUtil;
import io.agora.rtc.Constants;
import io.agora.rtc.IRtcEngineEventHandler;
import io.agora.rtc.RtcEngine;

public class RoleActivity extends AppCompatActivity implements EventHandler {
    ...
    private void gotoLiveActivity(int role) {
        ...
        intent.putExtra(github.lyl21.wanandroid.moudle.live.Constants.KEY_CLIENT_ROLE, role);
